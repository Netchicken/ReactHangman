...
const picWinArray = [W1, W2, W3,  W5, W6, W7, W8, W9];
const picLoseArray = [L1, L2, L3];

const words = ["fish", "cat", "walrus", "cabbage", "eel"];
...
export function randomWord() {
  return words[generateNumber(0, words.length)];
}

export function randomWinImage() {
  return picWinArray[generateNumber(0, picWinArray.length)];
}
export function randomLoseImage() {
  return picLoseArray[generateNumber(0, picLoseArray.length)];
}
